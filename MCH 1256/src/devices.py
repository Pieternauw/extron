...
dvSW = Scaler.SSHClass('128.114.163.20', 22023, Credentials=('admin', '100%Becknerized'), Model='DTP3 IN2004 DI/DO') #password
...
dvCynap = Cynap.EthernetClass('128.114.163.198', 50915,  Credentials=('admin', '100%Becknerized'), Model='Cynap Pure Pro')    

dvBiamp = Biamp.SSHClass('128.114.163.199', 22, Credentials=('admin', '100%Becknerized'), Model='TesiraFORTE DAN AI') #password
