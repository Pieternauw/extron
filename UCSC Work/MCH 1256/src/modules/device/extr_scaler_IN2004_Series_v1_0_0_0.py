...
class DeviceClass:
    ...
    def SetOutputAttenuation(self, value, qualifier):
        ...
        if OutputAttenuationConstraints['Min'] <= value <= OutputAttenuationConstraints['Max'] and qualifier['Output'] in outputdict:
            if qualifier['Output'] == 'HDMI/DTP Output':
                self.__SetHelper('OutputAttenuation', 'WG6000{0}*{1}AU\r'.format(outputdict[qualifier['Output']][0], value), value, qualifier)
                self.__SetHelper('OutputAttenuation', 'WG6000{0}*{1}AU\r'.format(outputdict[qualifier['Output']][1], value), value, qualifier)
            else:
                self.__SetHelper('OutputAttenuation', 'WG6000{0}*{1}AU\r'.format(outputdict[qualifier['Output']], value), value, qualifier)
        else:
